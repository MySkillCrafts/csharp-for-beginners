...
// LESSON 2: List Basics: Working with `List<string>`
// LESSON 3: List Operations: Add, Remove, Show Students
...
class Program
{
        ...
        while (running)
        {
            ...
            switch (choice)
            {
                ...
                case "15":
                    ...
                    break;
                case "16":
                    ConsoleHelper.ShowInfo("This demo has been simplified. Use options 1-3 to see List operations in action!");
                    break;
                case "0":
                    running = false;
                    break;
    ...
    // LESSON 2: List Basics: Working with `List<string>`
    // =============================================================================
    // Simple explanation: List<string> means "a list that holds only strings (student names)"
    // The <string> part tells C# what type of data goes in the list
    ...
    static void AddStudent()
    {
        ...
        // LESSON 2-3: Add to list - core operation
        studentNames.Add(name);

        // LESSON 2-3: Show list growth
        ...
        // LESSON 2-3: Demonstrate index access
    ...
    {
        // LESSON 2-3: Count property and display list contents using beautiful tables
    ...
    {
        // LESSON 2-3: Add initial students
