...
class Program
{
    static void Main()
    {
        ...
        // =============================================================================
        // LESSON 3: List Operations - Add, Remove, Contains, Clear
        // =============================================================================
        ...
        int afterAddingMore = studentNames.Count;
        
        // Show all students after adding
        ...
        // Show students after removal
        int studentsAfterRemoval = studentNames.Count;
        ...
        // Show students after index removal
        int studentsAfterIndexRemoval = studentNames.Count;
        
        // Checking students
        bool containsAlice = studentNames.Contains("Alice Johnson");
        bool containsBob = studentNames.Contains("Bob Smith");
        
        // Show final state before clearing
        int finalStudentCount = studentNames.Count;
